describe("Dowoload Invoice After Purchase Order", function(){
    before(function(){
    ...
    it("open",function() {
        ...
        //cy.get('.col-sm-9 > .btn-default').click(); //The following error originated from your application code, not from Cypress. It was caused by an unhandled promise rejection.
        cy.window().document().then(function (doc) {
            doc.addEventListener('click', () => {
              setTimeout(function () { doc.location.reload() }, 5000)
            })
            cy.get('.col-sm-9 > .btn-default').click().end();
          })
